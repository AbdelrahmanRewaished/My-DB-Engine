...
public class SQLParser extends Parser {
	...
	public static final int
		...
		PRIMARYKEY=26, INT=27, FLOAT=28, VARCHAR=29, DATE=30, CHECK=31, LETTER=32, 
		DIGIT=33, WS=34;
	public static final int
		...
		RULE_columnDefinitionConditionList = 17, RULE_dataType = 18, RULE_columnName = 19, 
		RULE_tableName = 20, RULE_value = 21, RULE_operator = 22, RULE_logicalOperator = 23, 
		RULE_integer = 24, RULE_double = 25, RULE_string = 26, RULE_date = 27;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"columnDefinitionConditionList", "dataType", "columnName", "tableName", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"AND", "OR", "XOR", "CREATE", "TABLE", "WHERE", "PRIMARYKEY", "INT", 
			"FLOAT", "VARCHAR", "DATE", "CHECK", "LETTER", "DIGIT", "WS"
		};
	}
